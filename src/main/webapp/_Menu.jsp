                        ...
                        <div class="header__top__links">
                            <c:if test="${sessionScope.acc != null}">
                                ...
                                <c:if test="${sessionScope.acc_nhan_vien != null}">
                                    <a href="edit-infor.jsp">Xin Chào NV ${sessionScope.acc_nhan_vien.getAcc_username()}</a>
                                </c:if>
                                <c:if test="${sessionScope.acc_khach_hang != null}">
                                    <a href="edit-infor.jsp">Xin Chào KH ${sessionScope.acc_khach_hang.getAcc_username()}</a>
                                </c:if>
