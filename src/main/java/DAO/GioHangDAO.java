...
public class GioHangDAO {
    ...
    public Hoa_don get_hoa_don_kh_id_limit1(int kh_id) {
        try {
            Connection connection = myConnection.getConnection();
